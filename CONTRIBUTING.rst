...
.. _issue:
    https://gitlab.audeering.com/tools/audobject/issues/new?issue%5BD=
.. _merge request:
    https://gitlab.audeering.com/tools/audobject/merge_requests/new
...
newest development version from Gitlab_::
    ...
    git clone git@srv-app-01.audeering.local:tools/audobject.git
    cd audobject
    # Use virutal environment
    pip install -r requirements.txt

.. _Gitlab: https://gitlab.audeering.com/tools/audobject
